...
ULONG Plat_EventRegister( LPCGUID ProviderId, PENABLECALLBACK EnableCallback, PVOID CallbackContext, PREGHANDLE RegHandle )
{
...
ULONG Plat_EventUnregister( REGHANDLE RegHandle )
{
...
//ULONG __stdcall Plat_EventWrite( REGHANDLE RegHandle, PCEVENT_DESCRIPTOR EventDescriptor, ULONG UserDataCount, PEVENT_DATA_DESCRIPTOR UserData )
//{
//	return (*s_pEventWrite)( RegHandle, EventDescriptor, UserDataCount, UserData );
//}
ULONG __stdcall Plat_EventWriteTransfer( REGHANDLE RegHandle, PCEVENT_DESCRIPTOR EventDescriptor, LPCGUID ActivityId, LPCGUID RelatedActivityId, ULONG UserDataCount, PEVENT_DATA_DESCRIPTOR UserData )
{
	return (*s_pEventWriteTransfer)( RegHandle, EventDescriptor, ActivityId, RelatedActivityId, UserDataCount, UserData );
}
ULONG __stdcall Plat_EventActivityIdControl( ULONG ControlCode, LPGUID ActivityId )
{
